...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Framework.LuaTableHandler), FrameworkLuaTableHandlerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Assets.Scripts.Common.Lua.LuaBehaviour), AssetsScriptsCommonLuaLuaBehaviourWrap.__Register);
