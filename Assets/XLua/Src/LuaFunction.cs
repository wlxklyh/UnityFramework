...
namespace XLua
{
    public partial class LuaFunction : LuaBase
    {
        ...
        #region Action
        public void Action<T1, T2, T3>(T1 para1, T2 para2, T3 para3)
        {
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
#endif
            RealStatePtr L = this.luaEnv.L;
            ObjectTranslator translator = this.luaEnv.translator;
            int oldTop = LuaAPI.lua_gettop(L);
            int errFunc = LuaAPI.load_error_func(L, this.luaEnv.errorFuncRef);
            LuaAPI.lua_getref(L, this.luaReference);
            translator.PushByType(L, para1);
            translator.PushByType(L, para2);
            translator.PushByType(L, para3);
        ...
        public void Action<T1, T2, T3, T4>(T1 para1, T2 para2, T3 para3, T4 para4)
        {
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
        ...
        public void Action<T1, T2, T3, T4, T5>(T1 para1, T2 para2, T3 para3, T4 para4, T5 para5)
        {
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
        ...
        #endregion
#region Func
        public TResult Func<T1, T2, T3, TResult>(T1 para1, T2 para2, T3 para3)
        {
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
        ...
        public TResult Func<T1, T2, T3, T4, TResult>(T1 para1, T2 para2, T3 para3, T4 para4)
        {
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
        ...
        public TResult Func<T1, T2, T3, T4, T5, TResult>(T1 para1, T2 para2, T3 para3, T4 para4, T5 para5)
        {
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
